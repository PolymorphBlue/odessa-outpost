...
/obj/landmark/costume/madscientist/New()
	...
	new /obj/item/clothing/head/hat/flatcap(src.loc)
...
/obj/landmark/costume/butler/New()
	...
	new /obj/item/clothing/head/hat/that(src.loc)
...
/obj/landmark/costume/prig/New()
	...
	var/CHOICE= pick( /obj/item/clothing/head/hat/bowler, /obj/item/clothing/head/hat/that)
	new CHOICE(src.loc)
