...
/obj/item/clothing/under/rank/expedition_overseer
	desc = "It's a jumpsuit worn by those with the know-how to achieve the position of \"Expedition Overseer\". Its fabric provides minor protection from biological contaminants."
